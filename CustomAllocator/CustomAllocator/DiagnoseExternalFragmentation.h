...
{
public:
	DiagnoseExternalFragmentation(const int totalMemory = 0, const diagnosticTypes diagType = diagnosticTypes::No_Diagnostic) : DiagnosticTools(totalMemory, diagType) {}
